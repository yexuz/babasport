			...
			<div class="sl-b-selected J_brandSelected">
				<span class="crumbs-arrow">已选条件：</span>
					<c:forEach items="${map }" var="m">
						<a title="依琦莲（yiqilian）"  href="javascript:;" class="crumb-select-item"  onclick="alert(1)"> 
		...
		<li data-sku="1711416562" class="gl-item">
			<div class="gl-i-wrap">
				...
				<div class="p-name p-name-type-2">
					<a t title="满129立减10,199减20优惠券,支持货到付款" href="javascript:;" onclick="window.open('http://127.0.0.1:8083/html/product/${product.id}.html')">
						<em>${product.name }</em>
					</a>
				</div>
				<div class="p-commit">
