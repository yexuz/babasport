...
function isShow(){
	...
	$("#jvForm").submit();
	 */
	var url = "/product/isShow.do";
	$.post(url, $("#jvForm").serialize(),function (data) {
		alert(data.message);
		$("#search").submit();
	},"json")
}
...
<div class="body-box">
<form id="search" action="/product/list.do" method="post" style="padding-top:5px;">
...
<table cellspacing="1" cellpadding="0" width="100%" border="0" class="pn-ltable">
	...
	<c:forEach items="${pagination.list}" var="product">
		<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
			...
			<td align="center">
			<a href="#" class="pn-opt">查看</a> | <a href="#" class="pn-opt">修改</a> | <a href="#" onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt">删除</a> | <a href="/sku/list.do?id=${product.id }" class="pn-opt">库存</a>
			</td>
		</tr>
	</c:forEach>
	</tbody>
