...
function optDelete(name,isDisplay,pageNo) {
	...
	$("#jvForm").attr({"action":"/brand/deletes.do?name="+name+"&isDisplay="+isDisplay+"&pageNo="+pageNo,"method":"POST"}).submit();
}
</script>
</head>
<body>
...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	<thead class="pn-lthead">
		<tr>
			<th width="20"><input id="ckAll" type="checkbox" onclick="checkBox('ids',this.checked)"/></th>
			<th>品牌ID</th>
			<th>品牌名称</th>
			<th>品牌图片</th>
			<th>品牌描述</th>
	...
	<tbody class="pn-ltbody">
		...
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			<td><input type="checkbox" value="${brand.id }" name="ids" onclick="ckBox(this.checked)"/></td>
